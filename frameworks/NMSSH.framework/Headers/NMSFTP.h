...
-(nullable NSString *) readSymbolicLinkAtPath:(NSString *)linkPath;

- (NSURL *)downloadFileAtPath:(NSString *)path;

- (NSURL *)downloadFileAtPath:(NSString *)path
                     progress:(BOOL (^)(NSUInteger, NSUInteger))progress;

- (NSURL *)downloadFileAtPath:(NSString *)path to:(NSURL *)url progress:(BOOL (^)(NSUInteger, NSUInteger))progress;
