...
internal class FileListPlaceholderCell: UITableViewCell {
    ...
    @IBOutlet var subtitilePlaceholder: UIView!
    ...
    override func didMoveToSuperview() {
        ...
        subtitilePlaceholder.backgroundColor = placeholdersColor
    ...
    private func randomScale() -> CGFloat {
        return CGFloat(arc4random_uniform(5) + 7) / 10
    }
    ...
    internal func beginAnimationWithDelay(delay: TimeInterval) {
        ...
        calculateTransform(scaleX: 0.5, view: subtitilePlaceholder)
        ...
        UIView.animate(withDuration: 0.2, delay: delay, options: [.curveEaseOut], animations: {
            ...
            self.calculateTransform(scaleX: self.randomScale(), view: self.subtitilePlaceholder)
            self.alpha = 1.0
        })
    }
}
