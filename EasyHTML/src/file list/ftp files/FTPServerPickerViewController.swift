...
internal class FTPServerPickerViewController: BasicMasterController, FTPNewServerDialogDelegate {
    ...
    internal override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Create custom detail button, as the native one does not work with accessoryView.
    ...
    internal func hideNoServersWarning() {
        ...
        guard let topLabel = noServersTopLabel else {
            return
        }
        noServersTopLabel = nil

        guard let bottomLabel = noServersBottomLabel else {
            return
        }
        noServersBottomLabel = nil
