...
internal class BasicMasterController: AlternatingColorTableView {
    ...
    func showErrorLabel(text: String!) {
        ...
        errorLabel.widthAnchor.constraint(lessThanOrEqualTo: view.widthAnchor, constant: -20).isActive = true
    }
    ...
    @objc internal func openPreferences(_ sender: UIButton) {
        ...
        PrimarySplitViewController.instance(for: view).openPreferences()
    }
