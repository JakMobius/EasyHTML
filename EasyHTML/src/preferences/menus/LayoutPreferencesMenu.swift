...
class LayoutPreferencesMenu: PreferencesMenu {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        section == 0 ? localize("themesectiontitle", .preferences) : section == 1 ? nil : localize("hapticfeedbackoptions", .preferences)
    }

    override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        section == 0 ? localize("usageofblacktheme", .preferences) : nil
    }

    override func numberOfSections(in tableView: UITableView) -> Int {
        UIDevice.current.isHapticFeedbackSupported ? 2 : 1
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        section == 0 ? Theme.themes.count : 1
    }
