...
class LanguagePreferencesMenu: PreferencesMenu {
    ...
    @objc override func exit(_ sender: UIBarButtonItem) {
    ...
    override func viewDidLoad() {
        ...
        self.title = localize("language", .preferences)
    ...
    func updateLanguage() {
        getBundle()
        self.title = NSLocalizedString("language", tableName: LocalizationTable.preferences.name, bundle: bundle, value: "", comment: "")
        self.navigationItem.leftBarButtonItem!.title = NSLocalizedString("ready", tableName: nil, bundle: bundle, value: "", comment: "")
    }
