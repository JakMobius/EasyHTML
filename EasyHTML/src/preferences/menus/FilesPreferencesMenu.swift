...
class FilesPreferencesMenu: PreferencesMenu {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard checkedIndex != indexPath.row else {
            return
        }
    ...
    override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        section == 0 ? FilesPreferencesMenu.descriptions[checkedIndex] : localize("sortdescription", .preferences)
    }
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        section == 0 ? localize("sortingtype", .preferences) : ""
    }
