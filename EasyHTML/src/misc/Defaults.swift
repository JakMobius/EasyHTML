...
class Defaults {
    ...
    internal static func int(forKey: String, def: Int = 0) -> Int {
        return (object(forKey: forKey.modified(), def: def) as? Int) ?? def
    }
    internal static func int8(forKey: String, def: Int8 = 0) -> Int8 {
        return (object(forKey: forKey.modified(), def: def) as? Int8) ?? def
    }
    internal static func float(forKey: String, def: Float = 0) -> Float {
        return (object(forKey: forKey.modified(), def: def) as? Float) ?? def
    }
    internal static func string(forKey: String, def: String = "") -> String {
        return (object(forKey: forKey.modified(), def: def) as? String) ?? def
    }
    internal static func bool(forKey: String, def: Bool = false) -> Bool {
        return (object(forKey: forKey.modified(), def: def) as? Bool) ?? def
    }
    
    internal static func data(forKey: String) -> Data? {
        return object(forKey: forKey.modified()) as? Data
    }
